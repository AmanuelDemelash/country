...
import 'package:country/app/modules/favorite/views/favorite_view.dart';
import 'package:country/app/modules/setting/views/setting_view.dart';
                        ...
                        return controller.loadCountries.value
                            ...
                            : Card(
                                ...
                                child: ListTile(
                                  ...
                                  leading: ClipRRect(
                                    ...
                                    child: Hero(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        height: 40,
                                        fit: BoxFit.fill,
                                        imageUrl: controller.allCountries
                                            .value[index].flags!.png!,
                                  ...
                                  title: Text(controller.allCountries
                                          .value[index].name?.common ??
                                      'Unknown'),
                                  subtitle: Text(controller.allCountries
                                          .value[index].region?.name ??
                                      'No capital'),
                                  onTap: () => Get.toNamed(
                                      Routes.COUNTRY_DETAIL,
                                      arguments:
                                          controller.allCountries.value[index]),
                                ),
                              );
                      },
